...
def prepare(job, baseline, output):
    ...
    try:
        ...
        report = {'profiles': [], 'channels': total, 'playlists': len(batches), 'epg_sources': len(source_ids)}
        for playlist_position,(name,profiles,filename) in enumerate(batches):
            ...
            values.update(name=name,url='file:///sdcard/Download/tidyTIVI/current/'+filename,
                ...
                expiration_date=None,max_connections=None,catchup_type=None,catchup_hours=None,
                catchup_source=None,stalker_token=None,position=playlist_position,logos_priority=1,
            ...
            for profile in profiles:
                ...
                for local_position,ch in enumerate(profile['channels']):
                    ...
                    v.update(playlist_id=pid, xc_id=None, stalker_id=None,
                        ...
                        catchup_type=None,catchup_hours=None,catchup_source=None,
